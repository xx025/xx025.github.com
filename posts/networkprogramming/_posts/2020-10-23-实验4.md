...
![Bk5XtO.png](https://cdn.jsdelivr.net/gh/img/20210127155122.png)

2.利用 xlwings，操作 Excel 文件，制作上述表格内容。制作步骤如 图标注 1-7。

![Bk5jhD.png](https://cdn.jsdelivr.net/gh/img/20210127155114.png)
...
```
输出：
![BEp078.png](https://cdn.jsdelivr.net/gh/img/20210127155100.png)